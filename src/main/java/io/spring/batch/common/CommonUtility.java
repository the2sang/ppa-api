...
public class CommonUtility {
    ...
    public final static String dateStr = ".";
    ...
    public static String getFormatDateTime(String dateString, String gubun) {
        ...
        try {
            if (dateString.length() < 12) {
                ...
                dateFormat422 = dateString.substring(0,4) + gubun + dateString.substring(4,6) + gubun + dateString.substring(6,8)+ " "+dateString.substring(8,10)+":"+dateString.substring(10,12)+":"+dateString.substring(12,14);
            }
        } catch(Exception e) {}
    ...
    public static String getMM(){
        Calendar cal =  Calendar.getInstance();
        String strTValue = "";
        strTValue += (cal.get(Calendar.MONTH)+1 >= 10) ? Integer.toString(cal.get(Calendar.MONTH)+1) : "0" + (cal.get(Calendar.MONTH)+1);
        return strTValue;
    }
    ...
    public static String getYYYYMMDDTIME(){
        ...
        strTValue += (cal.get(Calendar.MONTH)+1 >= 10) ? Integer.toString(cal.get(Calendar.MONTH)+1) : "0" + (cal.get(Calendar.MONTH)+1);
        strTValue += (cal.get(Calendar.DATE) >= 10) ? Integer.toString(cal.get(Calendar.DATE)) : "0" + (cal.get(Calendar.DATE));
        strTValue += (cal.get(Calendar.HOUR_OF_DAY) >= 10) ? Integer.toString(cal.get(Calendar.HOUR_OF_DAY)) : "0" + (cal.get(Calendar.HOUR_OF_DAY));
	...
	*/
    ...
    public static String REPLACE(String src, String str1, String str2){
        ...
        if(src == null || str2 == null || str1 == null || src.equals("") || str1.equals("") || str2.equals(""))
            return EMPTY_STRING;
        // argument의 length가 0일 경우 EMPTY_STRING을 리턴
        if((src.length() == 0)||(str1.length() == 0)||(str2.length() == 0))
            return EMPTY_STRING;
